        ...
        if explorar == 1 or explorar == 2 or explorar == 3: #Tela de combate
            ...
            while rato.status == "Vivo":
                ...
                if rato.vida <=0:
                    ...
                    jogador.mana = 100
                    limparTela()
                    drop = random.choice(list(rato.drop.items()))
                    print(f'O {rato.name} dropou:')
                    print(f"{drop}")
                    if drop == 'Potion of HP':
                        jogador.inventario['Potion of HP'] += 1
                    elif drop == 'Potion of MP':
                        jogador.inventario['Potion of MP'] += 1
        else:
